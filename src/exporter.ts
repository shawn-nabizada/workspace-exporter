...
import { generateFileTree, formatOutput } from './utils';
...
export const BUILTIN_TEMPLATES: TemplateDefinition[] = [
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.ts,*.tsx,*.js,*.jsx,*.html,*.css,*.scss,*.sass,*.json,*.md,*.cjs,*.mjs,*.config.js,*.config.ts}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.ts,*.tsx,*.js,*.jsx,*.html,*.css,*.scss,*.sass,*.less,*.styl,*.json,*.md}',
    exclude: '**/{node_modules,dist,build,.git,.idea,.vscode,coverage}/**'
  },
  {
    id: 'all_text_code',
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.txt,*.md,*.ts,*.tsx,*.js,*.jsx,*.html,*.css,*.scss,*.sass,*.json,*.cjs,*.mjs,*.kt,*.java,*.py,*.php,*.rb,*.go,*.rs,*.c,*.cpp,*.h,*.hpp,*.cs,*.swift,*.dart,*.lua,*.sh,*.yaml,*.yml,*.toml,*.xml,*.gradle,*.properties,*.sql}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.js,*.jsx,*.ts,*.tsx,*.json,*.md,*.env.example,*.env.sample}',
    exclude: '**/{node_modules,dist,build,.git,.idea,.vscode,coverage}/**'
  },
  {
    id: 'swift_app',
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.swift,*.plist,*.xib,*.storyboard,*.md,*.json,*.xcconfig,*.entitlements,*.Podfile,*.Cartfile}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.py,*.ipynb,*.json,*.yaml,*.yml,*.md,*.txt,*.csv,*.tsv}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.py,*.html,*.css,*.js,*.json,*.yaml,*.yml,*.md,*.txt,*.ini,*.wsgi}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.java,*.xml,*.gradle,*.properties,*.md,*.txt,*.kts}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.go,*.mod,*.sum,*.md,*.txt,*.json,*.yaml,*.yml}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.rs,*.toml,*.md,*.txt,*.json,*.yaml,*.yml}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.c,*.cpp,*.h,*.hpp,*.cc,*.hh,*.cxx,*.hxx,*.make,*.cmake,*.txt,*.md,*.json,*.yaml,*.yml,*.in}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.dart,*.yaml,*.yml,*.md,*.txt,*.json,*.xml,*.plist,*.gradle,*.properties}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.rb,*.erb,*.yml,*.yaml,*.md,*.txt,*.js,*.css,*.html,*.json,*.gemfile,*.lock,*.rake}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.php,*.blade.php,*.json,*.xml,*.yml,*.yaml,*.md,*.txt,*.env.example,*.htaccess,*.ini}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.cs,*.csproj,*.sln,*.json,*.xml,*.config,*.md,*.txt,*.props,*.targets,*.xaml,*.razor}',
  ...
  },
  {
    ...
    pattern: '**/{Dockerfile,docker-compose.yml,docker-compose.yaml,.dockerignore,*.tf,*.tfvars,*.hcl,*.dockerfile,*.yaml,*.yml,*.sh,*.bash,*.zsh,*.json,*.md,*.txt,*.conf,*.ini}',
